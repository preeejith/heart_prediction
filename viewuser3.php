...
<?php
		...
		$result = mysqli_query($conn,"SELECT * FROM register1 where District='idukki'");
?>
...
<!-- Navbar (sit on top) -->
                    <div class="w3-top">
                      <div class="w3-bar w3-white w3-padding w3-card" style="letter-spacing:4px;">
                            <a href="adminpage.html" class="w3-bar-item w3-button">Heart Disease Prediction</a>
 ...
 <select   type="text" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Search data">>
      ...
      <option value="kollam">Kollam</option>
        <option value="palakkad">Palakkad</option>
                                ...
                                <button><a href=viewuser2.php>Search by all </a></button>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM register1 WHERE CONCAT(Username,District,Email) LIKE '%$filtervalues%' ";
